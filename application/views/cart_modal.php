    ...
    <div class="modal-content">
      ...
      <div class="col-lg-12 col-md-12">
                ...
                <tr class="item first rowid<?php echo $data['rowid'] ?>">
                  ...
                  <td class="price">RS <span class="price<?php echo $data['rowid'] ?>"><?php echo $data['price'] ?></span></td>
                  ...
                  <td class="total">RS <span class="subtotal subtotal<?php echo $data['rowid'] ?>"><?php echo $data['subtotal'] ?></span></td>
                ...
                <tr class="item">
                  ...
                  <td class="">RS <span class="grandtotal">0</span> </td>
                  <td>&nbsp;</td>
                </tr>
              </tbody></table>
            </div>
